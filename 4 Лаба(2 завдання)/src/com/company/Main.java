...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Poet> performances = new LinkedList<>();
        ...
        do {
            ...
            switch (select) {
                case 1:
                    ...
                    break;
                case 2:
                    for (Poet performance : performances) {
                ...
                case 3:
                    ...
                    try {
                        ...
                        if (edit < 1)
                            throw new IOException("Порядковий номер не може бути відємний або нульовий");//System.out.println();
                        if (edit > performances.size())
                            throw new IOException("Введенего порядкового номера не знайдено");//System.out.println();
                ...
                case 9:
                    try (BufferedWriter bw = new BufferedWriter(new FileWriter("info.txt"))) {
                        for (Poet performance : performances) bw.write(performance.toSave());
    ...
    public static Poet input() throws IOException{
    ...
    public static Date searchDate(List<Poet> performances) throws IOException{
    ...
    public static int calculateTheAmountOfListenersByDate(List<Poet> performances,Date date){
        int result = 0;
